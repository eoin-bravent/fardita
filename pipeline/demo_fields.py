...
CHUNK_FIELDS = {
    ...
    "part_title":      "TITLE BREADCRUMB — Part heading (e.g. 'Contract Financing').",
    "subpart_title":   "Subpart heading (e.g. 'Progress Payments Based on Costs').",
    "section_title":   "Section heading (e.g. 'Postaward matters'); '' for Part-52 clauses / where none.",
    "subsection_title":"Subsection heading (e.g. 'Establishing alternate liquidation rates'). Together these 4 reconstruct the full hierarchy path.",
...
def main():
    ...
    print("\nFull field-by-field reference: docs/VERIFIED_FORMAT.md")
